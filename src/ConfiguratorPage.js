...
ConfiguratorPage.propTypes = {
  ...
  showOptionals: PropTypes.bool.isRequired,
  setShowOptionals: PropTypes.func.isRequired,
  MODELS: PropTypes.array.isRequired,
  SEATS_OPTIONS: PropTypes.array.isRequired,
  SEAT_PRICE_EXTRA: PropTypes.object.isRequired,
  TIRE_PRICE_EXTRA: PropTypes.object.isRequired,
  ...
  GolfCartPreview: PropTypes.elementType.isRequired,
  defaultMotorFor: PropTypes.func.isRequired,
  defaultBatteryFor: PropTypes.func.isRequired,
  motorPrice: PropTypes.func.isRequired,
  batteryPrice: PropTypes.func.isRequired,
  toggleOpt: PropTypes.func.isRequired,
  ru: PropTypes.func.isRequired,
  fr: PropTypes.func.isRequired,
  pl: PropTypes.func.isRequired,
  tNamePrefix: PropTypes.func.isRequired,
  cartDisplayName: PropTypes.string.isRequired,
  showRobotHint: PropTypes.bool.isRequired,
  SummaryBar: PropTypes.elementType.isRequired,
  showSeatOpts: PropTypes.bool.isRequired,
  setShowSeatOpts: PropTypes.func.isRequired,
  showSteerOpts: PropTypes.bool.isRequired,
  setShowSteerOpts: PropTypes.func.isRequired,
  showOtherInch: PropTypes.bool.isRequired,
  setShowOtherInch: PropTypes.func.isRequired,
  showGrass: PropTypes.bool.isRequired,
  setShowGrass: PropTypes.func.isRequired,
  showWindOpts: PropTypes.bool.isRequired,
  setShowWindOpts: PropTypes.func.isRequired,
  showTip: PropTypes.bool.isRequired,
  setShowTip: PropTypes.func.isRequired,
  showBattOpts: PropTypes.bool.isRequired,
  setShowBattOpts: PropTypes.func.isRequired,
  showMotorOpts: PropTypes.bool.isRequired,
  setShowMotorOpts: PropTypes.func.isRequired,
