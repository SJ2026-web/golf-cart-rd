...
const RU_DICT = {
  ...
  "Price includes taxes and standard delivery in the Dominican Republic. Remote or difficult-access locations may require a delivery adjustment.":"Цена включает налоги и стандартную доставку по Доминиканской Республике. Отдалённые или труднодоступные места могут потребовать корректировки стоимости доставки.",
  "On Order":"При заказе",
...
const FR_DICT = {
  ...
  "Price includes taxes and standard delivery in the Dominican Republic. Remote or difficult-access locations may require a delivery adjustment.":"Le prix inclut les taxes et la livraison standard en République Dominicaine. Les zones reculées ou difficiles d'accès peuvent nécessiter un ajustement du coût de livraison.",
...
const PL_DICT = {
  ...
  "Price includes taxes and standard delivery in the Dominican Republic. Remote or difficult-access locations may require a delivery adjustment.":"Cena obejmuje podatki i standardową dostawę na terenie Dominikany. Odległe lub trudno dostępne lokalizacje mogą wymagać korekty kosztu dostawy.",
...
export default function App() {
  ...
  const navItems = [
    ...
    {id:"maintenance",it:"Manutenzione",es:"Mantenimiento",en:"Maintenance"},
        ...
        <div style={{...S.sec,borderTop:"1px solid #222"}}>
          ...
          <div style={{marginTop:48,background:C.card,border:"1px solid #222",borderRadius:20,padding:"36px 28px",textAlign:"center"}}>
            ...
            <div style={{marginTop:20}}>
              <span onClick={()=>setPage("maintenance")} style={{color:C.muted,fontSize:12.5,textDecoration:"underline",cursor:"pointer"}}>
  ...
  function Service() {
    ...
    return (
      <div style={S.sec}>
        ...
        <h1 style={S.title}>{t("Assistance & Repairs","Asistencia y Reparaciones","Assistenza e Riparazioni")}</h1>
        <div style={S.goldLine}/>
        ...
        <div style={{marginBottom:40}}>
          ...
          <a href={"https://wa.me/18494100261?text="+encodeURIComponent(t6("Good morning, I have a question about assistance.","Buenos días, tengo una pregunta sobre la asistencia.","Buongiorno, ho una domanda sull'assistenza.","Bonjour, j'ai une question sur l'assistance.","Dzień dobry, mam pytanie dotyczące pomocy technicznej.","Здравствуйте, у меня вопрос по поводу поддержки."))} target="_blank" rel="noopener noreferrer" style={{display:"flex",alignItems:"center",justifyContent:"center",gap:8,background:"transparent",color:"#25D366",border:"1.5px solid #25D366",borderRadius:14,padding:"14px 20px",fontSize:14,fontWeight:700,textDecoration:"none",marginBottom:12}}>
  ...
  function Maintenance() {
    return (
      <div style={S.sec}>
        <div style={{color:C.gold,fontSize:10,letterSpacing:4,fontWeight:700,marginBottom:14,textTransform:"uppercase"}}>{t("Maintenance Plans","Planes de Mantenimiento","Piani di Manutenzione")}</div>
        <h1 style={S.title}>TAAAC Care</h1>
        <div style={S.goldLine}/>
    ...
    return (
      <div style={S.sec}>
        ...
        <div style={{display:"flex",gap:12,flexWrap:"wrap",marginBottom:12}}>
          ...
          <a href={"https://wa.me/18494100261?text="+encodeURIComponent(t6("Hi, I'm interested in Model "+modelId+".","Hola, me interesa el Modelo "+modelId+".","Ciao, sono interessato al Modello "+modelId+".","Bonjour, je suis intéressé par le Modèle "+modelId+".","Cześć, jestem zainteresowany/a Modelem "+modelId+".","Здравствуйте, меня интересует Модель "+modelId+"."))} target="_blank" rel="noopener noreferrer" style={{flex:1,minWidth:200,background:"transparent",color:"#25D366",border:"1.5px solid #25D366",borderRadius:14,padding:"16px 20px",fontSize:15,fontWeight:700,cursor:"pointer",textDecoration:"none",display:"flex",alignItems:"center",justifyContent:"center",gap:8}}>
            <svg viewBox="0 0 32 32" width="18" height="18" fill="#25D366"><path d="M16.001 3C9.373 3 4 8.373 4 15c0 2.625.86 5.055 2.312 7.031L4 29l7.157-2.281A11.94 11.94 0 0 0 16.001 27C22.628 27 28 21.627 28 15S22.628 3 16.001 3zm0 2c5.523 0 10 4.477 10 10s-4.477 10-10 10a9.96 9.96 0 0 1-5.086-1.398l-.365-.217-3.789 1.207 1.229-3.693-.239-.38A9.96 9.96 0 0 1 6 15c0-5.523 4.478-10 10.001-10zm-3.61 5.06c-.198 0-.52.074-.792.372-.271.297-1.04 1.016-1.04 2.479 0 1.463 1.065 2.876 1.213 3.075.148.198 2.057 3.278 5.076 4.462 2.516.988 3.028.792 3.575.743.546-.05 1.762-.72 2.01-1.414.247-.694.247-1.29.173-1.414-.074-.124-.271-.198-.568-.347-.297-.148-1.762-.87-2.036-.968-.273-.099-.472-.148-.67.148-.198.297-.767.968-.94 1.166-.173.198-.347.223-.644.074-.297-.148-1.253-.462-2.387-1.472-.883-.788-1.48-1.762-1.653-2.06-.173-.297-.019-.457.13-.605.134-.133.297-.347.446-.52.148-.174.198-.298.297-.496.099-.198.05-.372-.025-.52-.074-.148-.67-1.613-.918-2.208-.242-.583-.487-.504-.67-.513-.173-.008-.371-.01-.57-.01z"/></svg>
            WhatsApp
          </a>
        </div>
  ...
  function ReadyModels() {
    const readyPrice = 10900;
    const handleConfigureOwn = () => {
      upd("model", null);
      setPrevPage(page);
      setPage("configurator");
      setStep(-1);
      ...
      <div style={S.sec}>
        ...
        <div style={{background:C.card,border:"1px solid #222",borderRadius:18,padding:"28px 24px",marginBottom:24}}>
          ...
          <div style={{textAlign:"center",marginBottom:10}}>
            <span style={{background:"#C9A84C22",color:C.gold,padding:"4px 12px",borderRadius:20,fontSize:11,fontWeight:700,textTransform:"uppercase",letterSpacing:1}}>
              {t6("Special price","Precio especial","Prezzo speciale","Prix spécial","Cena specjalna","Специальная цена")}
            </span>
          </div>
          ...
          <p style={{color:C.muted,fontSize:14,lineHeight:1.8,marginBottom:14,maxWidth:640,marginLeft:"auto",marginRight:"auto",textAlign:"center"}}>
            {t6(
              ...
              "Golf cart elettrico da 4 posti, con un design moderno, sportivo e robusto, ideale per uso privato, ville, residence, resort, hotel e zone turistiche.",
              "Voiturette de golf électrique 4 places, au design moderne, sportif et robuste, idéale pour un usage privé, villas, résidences, resorts, hôtels et zones touristiques.",
              "Elektryczny wózek golfowy na 4 miejsca, o nowoczesnym, sportowym i solidnym designie, idealny do użytku prywatnego, willi, osiedli, resortów, hoteli i stref turystycznych.",
              "Электрический гольф-кар на 4 места с современным, спортивным и надёжным дизайном, идеально подходящий для частного использования, вилл, жилых комплексов, курортов, отелей и туристических зон."
            )}
          </p>
        ...
        <div style={{display:"flex",gap:12,flexWrap:"wrap",marginBottom:12}}>
          <a href={"https://wa.me/18494100261?text="+encodeURIComponent(t6(
            ...
            {t6("Contact us for a personalized quote","Contáctanos para un presupuesto personalizado","Contattaci per un preventivo personalizzato","Contactez-nous pour un devis personnalisé","Skontaktuj się z nami po indywidualną wycenę","Свяжитесь с нами для индивидуального расчёта стоимости")}
          </a>
        </div>

        <div style={{display:"flex",gap:12,flexWrap:"wrap",marginBottom:12}}>
          <button onClick={handleConfigureOwn} style={{...S.outBtn,flex:1,minWidth:220,textAlign:"center"}}>
            🚗 {t6("Configure your own personal model","Configura tu propio modelo personal","Configura il tuo modello personale","Configurez votre propre modèle personnel","Skonfiguruj swój własny model","Настройте свою личную модель")}
          </button>
        </div>
